...
struct pmppcorres_t {
        ...
        int probe;                      // - A flag for indicating whether the correspondent has already been probed.
        int rvp;                        // - A flag for indicating if the correspondent is a rendezvous point.
